  ...
  <div class="conditions-builder">
    ...
    <div v-else class="space-y-4">
      <div
        ...
        :key="groupIndex"
        class="rule-group overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm"
      >
        ...
        <div class="border-b border-gray-100 bg-gray-50/80 px-4 py-3">
          <div class="flex flex-wrap items-center gap-2">
            ...
            <Select v-model="group.logic" class="h-9 w-[5.5rem] shrink-0 text-sm">
            ...
            <Select v-model="group.action" class="h-9 min-w-[8.5rem] shrink-0 text-sm">
