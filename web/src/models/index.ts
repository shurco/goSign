...
export const AccountTypePersonal: AccountType = "personal";
export const AccountTypeOrganization: AccountType = "organization";
/**
...
export const OrganizationRoleViewer: OrganizationRole = "viewer";
/**
...
export interface Notification {
  ...
  scheduled_at?: any /* time.Time */;
  sent_at?: any /* time.Time */;
  related_type?: string;
  related_id?: string;
 ...
 */
export type SigningMode = string;
export const SigningModeSequential: SigningMode = "sequential";
export const SigningModeParallel: SigningMode = "parallel";
/**
...
export interface Submitter {
  ...
  order: number /* int */; // signing order for sequential mode
  completed_at?: any /* time.Time */;
  declined_at?: any /* time.Time */;
  sent_at?: any /* time.Time */;
  opened_at?: any /* time.Time */;
  metadata?: { [key: string]: any };
  created_at: any /* time.Time */;
  updated_at: any /* time.Time */;
}
...
export interface Webhook {
  ...
  secret: string;
  enabled: boolean;
  last_triggered_at?: any /* time.Time */;
