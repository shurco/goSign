...
<div class="organization-members-page">
  ...
  <div class="page-header">
    <div>
      ...
      <p class="page-subtitle">{t("organizationMembers.description")}</p>
    </div>
    <div class="page-actions">
      <Button variant="primary" onclick={() => (showInviteModal = true)}>
        <SvgIcon name="user-plus" class="h-4 w-4" />
      ...
      <div class="space-y-4">
        <div>
          <label class="mb-1 block text-sm font-medium text-gray-700" for="invite-email"
            >{t("organizationMembers.email")} *</label
          >
          <Input
            id="invite-email"
        ...
        <div>
          <label class="mb-1 block text-sm font-medium text-gray-700" for="invite-role"
            >{t("organizationMembers.role")} *</label
          >
          <Select id="invite-role" bind:value={formData.role} error={!!errors.role}>
            <option value="viewer">
