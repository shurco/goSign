...
<div class="submitter-sign-page min-h-screen bg-[--color-base-200]">
          ...
          >
            <div class="space-y-4">
              <div class="form-control">
                <label class="label" for="submitter-name">
              ...
              <div class="form-control">
                <label class="label" for="submitter-email">
                  <span class="label-text font-semibold">
                    {t("auth.email")}
                    <span class="text-error">*</span>
                  </span>
  ...
  {:else}
    ...
    <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap items-end gap-3">
              {#if showLanguageSelector}
                <div class="w-full sm:w-48">
                  <label class="mb-1 block text-xs font-medium text-gray-600" for="signing-locale"
      ...
      <div class="relative" role="presentation" onclick={onSigningAreaClick}>
      ...
      >
        <div class="space-y-3">
          <label class="block text-sm font-medium text-[--color-base-content]" for="decline-reason">
