...
<div class="submissions-page">
  ...
  {#snippet cellTemplateName(item: unknown, value: string)}
    <button type="button" class="link text-left" onclick={() => openCompletedDocument(item as Signing)}>
      {String(value || "")}
    </button>
  {/snippet}
    ...
    <div class="flex items-center justify-end gap-2">
      ...
      {#if String((item as Signing).status) === "completed"}
        <button
          ...
          onclick={() => openCompletedDocument(item as Signing)}
        >
    ...
    {#snippet children(formData, errors)}
      <div class="space-y-6">
        ...
        {#if expectedSubmittersCount > 0}
          ...
          >
            <div class="space-y-4" ondragover={(e) => e.preventDefault()} ondrop={onSignerDrop}>
