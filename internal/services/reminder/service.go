...
// Repository represents database operations for reminders
type Repository interface {
	GetSubmitters(ctx context.Context, submissionID string) ([]*models.Submitter, error)
}

// Service manages reminders for submitters
type Service struct {
...
func NewService(notificationSvc *notification.Service, repo Repository) *Service {
	return &Service{
...
func (s *Service) ScheduleReminders(ctx context.Context, submission *models.Submission, template *models.Template) error {
...
func (s *Service) SendImmediate(submitter *models.Submitter, submissionTitle string) error {
	notif := &models.Notification{
		Type:      models.NotificationTypeEmail,
		Recipient: submitter.Email,
		Template:  "reminder",
...
func (s *Service) CancelReminders(submissionID string) error {
...
func (s *Service) ProcessScheduled() error {
