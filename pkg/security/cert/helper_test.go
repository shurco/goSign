...
MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAET0ZOP4AF4tb8DUET4EnKQwns5IdA
8MrOlC5EArIvMWJuMOOj+5R6joFZc8c/WTY5Gx4WWV493tFAMz6mY8vGEw==
-----END PUBLIC KEY-----
`

	cert, err := readCertificateFile("./testdata/ca-cert.pem")
	if err != nil {
		t.Fatal(err)
	}
